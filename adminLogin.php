...
} elseif (isset($_SESSION['loggedIn']) && isset($_SESSION['user_id'])) {
...
if (isset($_POST['submit'])) {
    ...
    $log = $obj_adminAuth->login($email, $password);
    if ($log) {
...
<li class = 'nav-item'>
<a class = 'nav-link active' href = 'adminLogin.php' tabindex = '-1' aria-disabled = 'true'>Admin Login</a>
</li>
</nav> -->
    ...
    <a class = 'small' href = 'forgot-password.html'>Forgot Password?</a>
                                        ...
                                        <div class='text-center'>
                                            <a class='small' href='register.php'>Create a user Account!</a>
                                        </div>
                                </div>
                            </div>
                        </div>
