...
if (isset($_SESSION['admin_id'])) {
    ...
    //fetching total number of registered users
    $totalUsers = $objAdminFetch->countUsers();
    //fetching the total balance of registered users
    $totalBalance = $objAdminFetch->sumBalance();
    //fetching the total number of transactions
    $numOfTransaction = $objAdminFetch->countTransaction();
}
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        ...
                        <!-- Getting the total number of all registerd users -->
                        ...
                        <!-- Getting total balance of all users -->
                        <div class="col-xl-4 col-md-6 mb-4">
                                            ...
                                            <div class="row no-gutters align-items-center">
                                                <div class="col-auto">
                                                    <div class="h5 mb-0 mr-3 font-weight-bold text-gray-800">
                                                        <strong>₦ </strong><?=  number_format($totalBalance, 2); ?>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                        ...
                        <!-- Getting the total number of transactions that occured  -->
                        <div class="col-xl-4 col-md-6 mb-4">
                                ...
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            ...
                                            <div class="h5 mb-0 font-weight-bold text-gray-800"><?= $numOfTransaction; ?></div>
                                        </div>
                                    </div>
                                </div>
                            </div>
