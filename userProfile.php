...
if (isset($_SESSION['user_id'])) {
    ...
    $statesAndLga = $obj_Auth->getUsersStatesAndLga($user_id);
}
...
if (isset($_POST['update'])) {
    ...
    if (empty($firstName) || empty($otherName) || empty($email) || empty($phoneNumber) || empty($state) || empty($lga)) {
        $err = 'field can\'t be empty';
    } else {
        $update = $obj_Auth->update($user_id, $firstName, $otherName, $email, $phoneNumber, $state, $lga);
        if ($update) {
                        ...
                        <div class=" offset-xl-1 offset-md-1 col-xl-10 col-md-10 col-sm-12 mt-5">
                            <div class="card shadow">
                                <div class="card-header ">
                                    <h2 class="text-center"><?= $userDetails['firstname']; ?>'s Profile</h2>
                                </div>
                                <div class="card-body offset-1">
                                    ...
                                    <div class="row">
                                        <div class="col">
                                            <h4 class="card-title">
                                                <strong>Name:
                                                </strong><?= $userDetails['firstname'].' '.$userDetails['othername']; ?>
                                            </h4>
                                            <h4 class="card-title"><strong>Phone Number:
                                                </strong><?= $userDetails['phone_no']; ?>
                                            </h4>
                                            <h4 class="card-title"><strong>E-mail:
                                                </strong><?= $userDetails['email']; ?>
                                            </h4>
                                            </h4>
                                            <h4 class="card-title"><strong>Account Number:
                                                </strong><?= $userDetails['account_no']; ?></h4>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title"><?= $userDetails['firstname']; ?>'s profile update</h5>
